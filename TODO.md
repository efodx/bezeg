...
- [x] Oznake za transformacije pri izbrani krivulji - pac pointer changes.
- [x] Kontrolne točke racionalnih se ne prikazujejo!! :(
- [ ] Razni setterji v grafih, ki hkrati updatajo graf, bi morali update delat v componentDidUpdate in ne na nacin, ki
  ga delajo sedaj.
