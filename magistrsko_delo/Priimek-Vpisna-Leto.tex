...
%    \end{dokaz}
    ...
    \begin{izrek}
        Naj bosta $f$ in $g$ Bernsteinova polinoma s funkcijskimi predpisi $f(t)=\sum_{i=0}^{m}B_i^m(t)$ in $g(t)=\sum_{i=0}^{n}B_i^n(t)$.
    ...
    \end{opomba}
    Na sliki~\ref{fig:bezierjeva-krivulja} si lahko ogledamo primere Bezierjevih krivulj in njihovih kontrolnih poligonov za stopnje $n=1,2,3,4$.
    \begin{figure}[ht!]
        \captionsetup[subfigure]{labelformat=empty}
        \centering
...
%    \end{dokaz}
    ...
    Direktno računanje vrednosti Bernsteinovih polinomov preko enačb iz definicije~\ref{def:bernstein} pa ni stabilno~\cite{24ac2b10-13c2-3e17-bc91-5f7366bf076c}.
...
%    \end{figure}
    ...
    Radovedni bralci lahko dokaz trditev najdejo v delu~\cite{24ac2b10-13c2-3e17-bc91-5f7366bf076c}.
    ...
    Če subdivizijo nato ponavljamo na dobljenih krivuljah, imamo po $k$ korakih $2^k$ krivulj.
