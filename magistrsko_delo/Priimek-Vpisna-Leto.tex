...
\begin{document}
    ...
    \begin{izrek}
        \label{izrek:bernsteinovi_lastnosti:rekruzija}Bernsteinovi bazni polinomi ustrezajo rekurzivni zvezi
    ...
    \begin{dokaz}
        ...
        \begin{align*}
        (1-t)
            B_i^{n-1}(t) + tB_{i-1}^{n-1}(t)  &= (1-t)\binom{n-1}{i}t^{i}(1-t)^{n-i-1} + t\binom{n-1}{i-1}t^{i-1}(1-t)^{n-i}  \\
    ...
    \begin{figure}[ht!]
        \captionsetup[subfigure]{labelformat=empty}
        \centering
        \subfloat[$n=2$]{\includegraphics[width = 0.45\textwidth]{images/bezier-curve-2}}
        \qquad
        \subfloat[$n=2$]{\includegraphics[width = 0.45\textwidth]{images/bezier-curve-2-control}} \\
        \subfloat[$n=3$]{\includegraphics[width = 0.45\textwidth]{images/bezier-curve-3}}
        \qquad
        \subfloat[$n=3$]{\includegraphics[width = 0.45\textwidth]{images/bezier-curve-3-control}}\\
        \subfloat[$n=4$]{\includegraphics[width = 0.45\textwidth]{images/bezier-curve-4}}
        \qquad
    ...
    \begin{dokaz}
        ...
        Konveksna ovojnica kontrolnih točk Bezierjeve krivulje je množica vseh konveksnih kombinacij teh točk, t.j.\ $\sum_{i=0}^{n}\lambda_i\p_{i}$, kjer so $\lambda_i$ nenegativna realna števila za katere velja $\lambda_0 + \lambda_1 + \dots + \lambda_n = 1$.
    ...
    \begin{figure}[ht!]
        ...
        \qquad
        \subfloat[Povečana krivulja]{\includegraphics[width = 0.45\textwidth]{images/afine-transform-bigger}} \\
        \subfloat[Zracljena čez $x$ os]{\includegraphics[width = 0.45\textwidth]{images/afine-transform-flip}}
        \qquad
        \subfloat[Rotirana krivulja]{\includegraphics[width = 0.45\textwidth]{images/afine-transform-rotate}}
    ...
    \begin{izrek}
        ...
        Potem lahko njene točke rekurzivno računamo s pomočjo naslednjega izraza \[\bigbbt_{[\p_0,\p_1,\dots,\p_n]} = (1-t)\bigbbt_{[\p_0,\p_1,\dots,\p_{n-1}]} +t\bigbbt_{[\p_1,\p_2,\dots,\p_n]}.\]
    \end{izrek}
    \newpage
    Izrek tudi dokažimo.
    \begin{dokaz}
        Rekurzivno zvezo iz izreka razpišemo in računamo, da dobimo
        \begin{align*}
        (1-t)
            &
    ...
    \end{dokaz}
    Pišimo sedaj $\p_{i}^r(t) = \bigbbt_{[\p_i,\p_{i+1},\dots,\p_{i+r}]}$.
    Velja torej $\p_{i}^0(t)=\p_i$ in  $\p_{0}^n(t)=\bigbbt_{[\p_0,\p_1,\dots,\p_n]}$.
    Iz prejšnjega izreka sledi, da lahko točke Bezierjeve krivulje $\bigbbt_{[\p_0,\p_1,\dots,\p_n]}$ računamo s pomočjo \textit{Decasteljaujeve sheme}.
    \begin{center}
        ...
        \end{tabular}
    \end{center}
    Izračun točke Bezierjeve krivulje za poljubno število $t$ lahko sedaj podamo v obliki algoritma~\ref{alg:decasteljau}.
    \begin{algorithm}
    ...
    Prvi višjih $n$ pa algoritem predstavlja zaporedno interpolacijo točk.
    Na slikah~\ref{fig:dec-alg-n2},~\ref{fig:dec-alg-n3},~\ref{fig:dec-alg-n5} lahko vidimo, da algoritem interpolira sosednje točke na $r$-tem nivoju.
    \begin{figure}[h!]
        \captionsetup[subfigure]{labelformat=empty}
        \centering
