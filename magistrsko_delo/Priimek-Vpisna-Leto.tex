...
%    \vspace{-0.2cm}
    \begin{enumerate}[wide, labelwidth=!, labelindent=10pt]
        ...
        \item Enako kot v točki 3. dobimo tudi v primeru, ko je polinom $w$ neničelen in en izmed polinomov $u$ in $v$ je ničelen.
    \end{enumerate}
...
%    Takšni hodografi definirajo regularne PH krivulje, saj za njih velja
    ...
    \end{align}
    Kontrolno točko $\p_0=(x_0,y_0)$ smo izbrali poljubno, saj sta $x_0$ in $y_0$ integracijski konstanti.
    ...
    Za pravkar definirane kubične PH krivulje to pomeni, da imajo le $6$ prostih parametrov.
    ...
    Za polinoma $u$ in $v$ tokrat izberemo Bernsteinova polinoma polinoma stopnje $2$,
...
%    Izpeljimo še funkcijo dolžine PH krivulje.
    ...
    Zapišimo kontrolne točke Bezierjeve $PH$ krivulje $\mathbf{r}$ s homogenimi koordinatah
