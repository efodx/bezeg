...
%
    ...
    \begin{figure}[h]
        ...
        \qquad
        \subfloat[premik $\p1$]{\includegraphics[width = \groupimagewidth]{images/enostranski-spline-3}}
        \qquad
        \subfloat[premik $\p8$]{\includegraphics[width = \groupimagewidth]{images/enostranski-spline-2}}
    ...
    \begin{figure}[h]
        ...
        \qquad
        \subfloat[premik $\p1$]{\includegraphics[width = \groupimagewidth]{images/simetricni-c1-spline-2}}
        \qquad
        \subfloat[premik $\p8$]{\includegraphics[width = \groupimagewidth]{images/simetricni-c1-spline-3}}
        \caption{Obnašanje simetričnega kvadratnega $C^1$ zlepka.}
    ...
    \begin{figure}[h]
        ...
        \subfloat[začetni zlepek]{\includegraphics[width = \groupimagewidth]{images/simetricni-c1-spline-1}}
        \qquad
        \subfloat[premik $\p1$]{\includegraphics[width = \groupimagewidth]{images/simetricni-c2-spline-2}}
        \qquad
        \subfloat[premik $\p8$]{\includegraphics[width = \groupimagewidth]{images/simetricni-c2-spline-3}}
        \caption{Obnašanje simetričnega kubičnega $C^2$ zlepka.}
    ...
    Primere afinih transformacij simetričnega $C^2$ zlepka si lahko ogledamo na sliki~\ref{fig:afini-zlepek}.
    ...
    \begin{figure}[h]
        ...
        \caption{Afini transformaciji simetričnih kubičnih $C^2$ zlepkov.}
    ...
    \begin{figure}[h]
        ...
        \caption{Konveksni ovojnici simetričnih kubičnih $C^2$ zlepkov.}
        \label{fig:ovojnica-zlepek}
    \end{figure}
    Algoritem za simetrični kvadratni $C^1$ zlepek lahko adaptiramo tako, da upoštevamo pogoj~\ref{eq:g1-pogoj} za $G^1$ zveznost.
    ...
    \begin{algorithm}[H]
        ...
        \begin{algorithmic}
            \State $\p \gets \p_0,\p_1,\dots,\p_{m}$
            \State $\beta \gets \beta_1,\beta_2,\dots,\beta{m-2}$
            \State $\p_0^{(1)} = \p_0$
            \State $\p_1^{(1)} = \p_1$
            \For{$l = 1,2,\dots m-2$}
                \State $\p_1^{(l)}=\p_{l}$
    ...
    V praksi delilnih točk $u_i$ dostikrat ne dobimo podanih ampak jih izračunamo sami.
    Smiselno jih je postaviti tako, da s parametrom $t$ po krivulji potujemo čim bolj enakomerno.
    Točke $u_i$ bi radi izbrali tako, da velja \[\Delta u_i = dolzina\_krivulje(\mathbf{s}^{(i)}).\]
