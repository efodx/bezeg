...
%    Lahko dodam v program, da se narisejo te crtkane crte po katerih se premikajo kontrolne točke te odmik krivulje...}
    ...
    \begin{figure}[h]
        ...
        \caption{Rotacija in skaliranje krivulje in pripadajočimi števili $w_i$.}
...
\end{lstlisting}
    ...
    Hierarhijo si lahko ogledamo na sliki~\ref{fig:hiearhija-jxg-krivulj}.
...
\begin{lstlisting}[label={lst:ghdfg}]
 ...
 jxgBezierCurve.moveFor(2,3);
    \end{lstlisting}
    Poleg takšnih metod ima razred JXGPointControlledCurve tudi metode za procesiranje potez uporabnikove miške processMouseDown, processMouseMove, processMouseUp, ki skrbijo za to, da lahko uporabnik z rabo miške transformira izbrano krivuljo.
 \subsubsection{Grafi}
    Za inicializacijo grafa knjižnice JSXGraph in funkcionalnosti naštete v razdelku~\ref{subsec:gui} skrbi abstrakten razred BaseGraph, ki ima abstraktno metodo initialize.
    Posamezna implementacija razreda BaseGraph implementira metodo initialize, da na grafu nariše željeno.
    ...
    Graf za višanje stopnje krivulje na naslednji način ustvari gumb, ki ob kliku zviša stopnjo krivulje
