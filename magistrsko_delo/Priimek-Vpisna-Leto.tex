...
\naslov{Orodje za grafični prikaz konceptov Bézierjevih in PH krivulj}
...
%    \end{dokaz}
    ...
    Ker so Bernsteinovi bazni polinomi definirani za vsa realna števila $t$, lahko Bézierjeve krivulje rišemo tudi izven intervala $[0,1]$.
    Recimo, da želimo neko Bézierjevo krivuljo risati na intervalu $[0,t_0]$, kjer je $t_0>1$.
    Bézierjevo krivuljo na intervalu $[0,t_0]$ lahko zapišemo kot Bézierjevo krivuljo na intervalu $[0,1]$.
...
%&=\mathbf{p}_{0} + \sum_{i=1}^{n}\left(\mathbf{p}_{i}\frac{n+1-i}{n+1} + \mathbf{p}_{i-1}\frac{i}{n+1}\right)B_{i}^{n+1}(t)+\mathbf{p}_{n}.
    ...
    \subsection{Odvod Bézierjeve krivulje}
    ...
    \begin{figure}[h]
        \centering
        \subfloat[]{\includegraphics[width = \groupimagewidth]{images/racionalna-start}}
        \qquad
        \subfloat[]{\includegraphics[width = \groupimagewidth]{images/racionalna-subdivizija}}\\
        \subfloat[]{\includegraphics[width = \groupimagewidth]{images/racionalna-ekstrapolirana}}
        \qquad
        \subfloat[]{\includegraphics[width = \groupimagewidth]{images/racionalna-dvig}}
