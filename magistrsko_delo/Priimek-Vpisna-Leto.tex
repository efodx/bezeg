...
%    Lahko dodam v program, da se narisejo te crtkane crte po katerih se premikajo kontrolne točke te odmik krivulje...}
    ...
    Ko uporabnik klikne na krivuljo, jo s tem tudi izbere.
    Na desni strani vsakega grafa se ob izbrani krivulji kartica z ukazi na grafu zamenja s kartico z ukazi izbrane krivulje.
    Primere takšnih kartic si lahko ogledamo na sliki~\ref{fig:izbrana-krivulja}.
    \begin{figure}[h!]
        \captionsetup[subfigure]{labelformat=empty}
        \centering
        \subfloat[polinomska Bezierjeva]{\includegraphics[width = \groupimagewidth]{images/bezeg/izbrana-krivulja-bezier}}
        \qquad
        \subfloat[racionalna Bezierjeva]{\includegraphics[width = \groupimagewidth]{images/bezeg/izbrana-krivulja-rational}}
        \qquad
        \subfloat[PH]{\includegraphics[width = \groupimagewidth]{images/bezeg/izbrana-krivulja-ph}}
        \caption{Kartice z ukazi za različne izbrane krivulje.}
        \label{fig:izbrana-krivulja}
    \end{figure}
    Naštejmo sedaj ukaze posamičnih krivulj.
    \begin{itemize}
    ...
    \item  Bézierjeva krivulja premore poleg osnovih ukazov še ukaze za subdivizijo, ekstrapolacijo, skrčitev, višanje stopnje, ter prikazovanje De Casteljaujeve sheme.
        ...
        \item  Racionalna Bézierjeva Krivulja ima poleg funkcionalnosti bezierjeve krivulje še dodane ukaze za prikaz in spreminjanje uteži, ter drsnik za preklapljanje forme uteži.
        ...
        Prikazovanje odmik krivulj in spreminjanje velikosti odmika.
        Prikaz kontrolnih točk odmik krivulj ter prikazovanje premic na katerih ležijo.
        Dodajanje in odstranjevanje odmik krivulj.
        Koordinatni sistem z interaktivnimi točkami, ki predstavljajo hodografe.
    ...
    \begin{figure}[h!]
        \captionsetup[subfigure]{labelformat=empty}
        \centering
        \subfloat[]{\includegraphics[width = \groupimagewidth]{images/bezeg/prikaz-rezultata}}
        \caption{Predogled rezultata za skrčitev.}
        \label{fig:bezier:prikaz-rezultata}
    \end{figure}


    \subsection{Transformacije izbrane krivulje}
    Ko je krivulja izbrana, je okoli nje
    ...
    \begin{figure}[h!]
        \captionsetup[subfigure]{labelformat=empty}
        \centering
        \subfloat[]{\includegraphics[width = \groupimagewidth]{images/bezeg/resize-start}}
        \qquad
        \subfloat[]{\includegraphics[width = \groupimagewidth]{images/bezeg/resize-end}}
