...
%    Lahko dodam v program, da se narisejo te crtkane crte po katerih se premikajo kontrolne točke te odmik krivulje...}
    ...
    \subsubsection{Osnovni vmesniki}
...
interface Point {
 ...
 setY: (y: number | (() => number)) => void;
    ...
    \end{lstlisting}
    Koordinati X in Y sta funkciji in ne fiksni števili.
    Tak vmesnik omogoča večjo fleksibilnost točk.
    Vmesnik za upravljanje s krivuljo, ki temelji na kontrolnih točkah je naslednji
...
class PointImpl2 implements Point {
    ...
    \end{lstlisting}
    Takšen ovoj nam omogoča, da točke iz knjižnice jsxgraph uporabljamo v svojih krivuljah.
