...
export class JXGQuadraticC1SplineCurve extends AbstractJXGSplineCurve<C1QuadraticBezierSpline> {
    ...
    protected getInitialCurve(points: number[][]): C1QuadraticBezierSpline {
